...
# 使用AdaBoost集成算法，基学习器为决策树回归模型，并通过交叉验证找到最佳参数  
...
grid_search = GridSearchCV(AdaBoostRegressor(base_estimator=base_estimator, random_state=42), param_grid, cv=10, scoring='neg_mean_squared_error')
