...
from sklearn.ensemble import RandomForestRegressor  # 修改导入的模型
...
model = RandomForestRegressor(**optimal_params)  # 修改模型初始化
...
# 将所有结果保存到CSV文件
results_df.to_csv("G:/BaiduSyncdisk/0.我的工作/5.隧穿相图/1.正式代码/2.代码/BayesSearch/For20-LOO/RF/results.csv", index=False)
average_results_df.to_csv("G:/BaiduSyncdisk/0.我的工作/5.隧穿相图/1.正式代码/2.代码/BayesSearch/For20-LOO/RF/average_results.csv", index=False)