...
optimal_params = {
    'n_estimators': 100,
    #'iterations': 1000,  # 迭代次数，可以根据需要调整
    'learning_rate': 0.751409,  # 学习率
    'l2_leaf_reg': 0.001,
    'depth': 3,  # 树的深度
    #'min_samples_in_leaf': 5,  # 叶节点中的最小样本数
    'subsample': 1.0, 
    'random_state': 42,  # 随机种子
    'verbose': 0 # 不打印每次迭代的详细信息
}
...
for i in range(k_folds):
    ...
    avg_deviation_train_percent = ((10 ** rmse_train) - 1) * 100
    ...
    avg_deviation_test_percent = ((10 ** rmse_test) - 1) * 100
...
# 将所有结果保存到CSV文件
results_df.to_csv("G:/BaiduSyncdisk/0.我的工作/5.隧穿相图/1.正式代码/2.代码/BayesSearch/For20-LOO/CB/results.csv", index=False)
average_results_df.to_csv("G:/BaiduSyncdisk/0.我的工作/5.隧穿相图/1.正式代码/2.代码/BayesSearch/For20-LOO/CB/average_results.csv", index=False)